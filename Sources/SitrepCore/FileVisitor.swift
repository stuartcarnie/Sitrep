...
class FileVisitor: SyntaxVisitor {
    ...
    override func visit(_ node: SourceFileSyntax) -> SyntaxVisitorContinueKind {
        comments = comments(for: Syntax(node))
        body = "\(node)"
...
//        }
        ...
        let newObject = Type(type: type, name: name, inheritance: inheritanceClause, comments: comments(for: node.syntax), body: nodeBody, strippedBody: nodeBodyStripped)
